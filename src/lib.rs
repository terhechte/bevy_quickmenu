    ...
    fn build(&self, app: &mut bevy::prelude::App) {
        app.insert_resource(self.options.unwrap_or_default())
            ...
            .add_systems(
                Update,
                (
                    crate::systems::keyboard_input_system,
                    crate::systems::input_system::<S>,
                    crate::systems::mouse_system::<S>,
                    crate::systems::redraw_system::<S>,
                )
...
pub trait ActionTrait: Debug + PartialEq + Eq + Clone + Copy + Hash + Send + Sync {
    type State;
    type Event: Send + Sync + 'static + bevy::prelude::Event;
